...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://RAXIE:@cluster0.jbsyz.mongodb.net/?retryWrites=true&w=majority")

DATABASE_NAME = environ.get('DATABASE_NAME', "moti")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'motki')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '0'))
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/nJp.jpg')
START_IMG = environ.get('START_IMG', 'https://iili.io/2F9eh4j.md.jpg')
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','0'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','0'))
URL = environ.get('URL', 'mytestbot-jvdfhbj.com')
STICKERS_IDS = ('CAACAgIAAxkBAAEM2M9m7nBzlP0-DbS_D_TpWEH6XFMVVAADGgACFLvwSLdQCDPPbD-TNgQ').split()
